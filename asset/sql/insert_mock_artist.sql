INSERT INTO artist(ID_ARTIST, ARTIST_LAST_NAME, ARTIST_FIRST_NAME, STAGE_NAME, BIOGRAPHY)
VALUE (0, 'DJ', 'Thierry', 'Frére rodrigue n°1', 'DJ Thierry est un passionné de musique et un grand entrepreneur qui a su se faire un nom dans le monde de la musique électronique. Depuis son plus jeune âge, il a été fasciné par les sonorités électroniques et a rapidement commencé à expérimenter avec la musique et les platines.
...
INSERT INTO artist(ID_ARTIST, ARTIST_LAST_NAME, ARTIST_FIRST_NAME, STAGE_NAME, BIOGRAPHY)
VALUE (1, 'LAFFINE', 'Melvyn', 'Miel-vigne', 'Miel-vigne est un DJ passionné de musique et originaire d''un petit village de Haute-Savoie. Depuis son plus jeune âge, il a été fasciné par les sonorités électroniques et a rapidement commencé à expérimenter avec la musique et les platines.
...
INSERT INTO artist(ID_ARTIST, ARTIST_LAST_NAME, ARTIST_FIRST_NAME, STAGE_NAME, BIOGRAPHY)
VALUE (2, 'LUCAS', 'Liam', 'Wayark', 'Liam LUCAS, connu sous le nom de scène "Wayark", est un guitariste passionné et talentueux originaire de la région lyonnaise. Depuis son plus jeune âge, il a été fasciné par la musique et a commencé à apprendre la guitare dès l''âge de 8 ans.
