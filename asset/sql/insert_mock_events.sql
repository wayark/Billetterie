...
INSERT INTO event(idevent, eventname, country, city, street, hall, date, idtypeevent, idpicture, organizerid, nbplacespit,
                  nbseatsstaircase, idartist, description)
VALUES (0, 'Soirée mousse', 'France', 'Lyon', '3 rue de la tech', 'Le transbordeur', '2021-01-01', 0, 0, 0, 100, 100, 0, 'Enfin, la soirée que l''on attendait tous ! Une soirée mousse, avec des jeux, des surprises, et des animations ! ');
